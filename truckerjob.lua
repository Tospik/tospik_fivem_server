...
function GUI.drawStartText()
    TriggerEvent("mt:missiontext", "Devenez routier et effectuez des livraisons, appuyez sur ~r~N+~w~ pour commencer.", 500)
...
function GUI.init()
    GUI.loaded = true
    GUI.addTitle("Vous êtes désormais routier.", 0.425, 0.19, 0.45, 0.07 )
    ...
    GUI.addButton(1, "Test [ 100$ ]", GUI.mission, 0.35, 0.50, 0.3, 0.05)
